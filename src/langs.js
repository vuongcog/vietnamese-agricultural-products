import { LANGUAGE_GLOBAL_ADMIN } from './constants/langs-scope';

const langsGlobal = {
  sendmail: LANGUAGE_GLOBAL_ADMIN + '.sendmail',
  ...
  placeholderSearch: LANGUAGE_GLOBAL_ADMIN + '.placeholderSearch',
  placeholderId: LANGUAGE_GLOBAL_ADMIN + '.placeholderId',
};
export default langsGlobal;
